      ...
      <div className="container">
        <div className="banner-product">
          <div className="banner-product-column">
            <div className="banner-product-top">
              ...
              <Link to="/detail" className="banner-layout-main">
                <div className="banner-product-top-main-left">
                  <img
                    alt=""
                    src={
                      "https://encrypted-tbn0.gstatic.com/shopping?q=tbn:ANd9GcQENaOM_3iR1z_J8GHj8iQxo8oLWOQXvX3fZ_1gXEuxIZvLqlcQNVqIzMxtJI3mK3ZRU79htrZ8oPs&usqp=CAc"
                    }
                  />
                </div>
                <div className="banner-product-top-main-right">
                  <p>
                    <strong>
                      Tablet Thin EliteBook Revolve 810 G6 Tablet Thin EliteBook
                      Revolve 810 G6 Tablet Thin EliteBook Revolve 810 G6
                    </strong>
                  </p>
                  <p>$1,800,00</p>
                  <div className="star-product-home">
              ...
              <div className="banner-layout-main">
                <div className="banner-product-top-main-left">
                  <img
                    alt=""
                    src={
                      "https://encrypted-tbn0.gstatic.com/shopping?q=tbn:ANd9GcRlMRtJm_sSqzTYTZ6USnLUmQ0HM4xCxMmBLEpjR8aivrt0elH1BGHm9mv4zZg5&usqp=CAc"
                    }
                  />
                </div>
                <div className="banner-product-top-main-right">
